          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 border-2 border-black p-10">
              <div className="flex items-start space-x-4">
                <div className="w-14 h-14 bg-black flex items-center justify-center flex-shrink-0"><VialIcon size={38} /></div>
                <div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[100] flex items-center justify-center p-6">
          <div className="bg-white max-w-md w-full p-8 shadow-2xl">
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-black mx-auto flex items-center justify-center mb-4"><VialIcon inverted={false} size={58} /></div>
              ...
              <div className="space-y-6 max-w-2xl mx-auto">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="w-6 h-6 bg-black flex items-center justify-center"><VialIcon size={23} /></div>
