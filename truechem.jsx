...
export default function TruchemWebsite() {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 border-2 border-black p-10">
              <div className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-black flex items-center justify-center flex-shrink-0"><VialIcon size={60} /></div>
                <div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
            <div className="flex items-center justify-between h-20">
              <button onClick={() => setCurrentPage('home')} className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-black flex items-center justify-center"><VialIcon inverted={false} size={60} /></div>
                <div>
                  <div className="text-2xl font-mono text-black lowercase" style={{ letterSpacing: '0.08em' }}>
                    <span className="font-bold">true</span>
                    <span className="font-normal">chem</span>
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="grid md:grid-cols-4 gap-12 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Certificates of Analysis</a></li>
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[100] flex items-center justify-center p-6">
          <div className="bg-white max-w-md w-full p-8 shadow-2xl">
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-black mx-auto flex items-center justify-center mb-4"><VialIcon inverted={false} size={90} /></div>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-12">
              Every batch tested by independent laboratories using HPLC and mass spectrometry
            </p>
            ...
            <div className="bg-gray-50 border border-gray-200 p-12 mb-8">
              ...
              <div className="relative h-4 bg-gray-200 overflow-hidden mb-6">
                <div 
                  className="absolute inset-y-0 left-0 bg-black will-change-transform"
                  style={{ 
                    width: `${purityValue}%`
                  }}
                />
            ...
            <div className="mt-16 pt-12 border-t border-gray-200">
              <h3 className="text-2xl font-bold text-black mb-8 text-center">Industry Standards</h3>
              ...
              <div className="space-y-6 max-w-2xl mx-auto">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-black flex items-center justify-center"><VialIcon size={45} /></div>
      ...
      {/* Why truechem Section */}
      <section id="why-truechem" className="py-20 px-6 lg:px-12 bg-[#FAFAFA]">
        <div className="max-w-[1400px] mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="pt-6 border-t border-gray-800">
                <p className="text-sm text-gray-400">
                  Every batch independently tested. No exceptions.
                </p>
              </div>
            </div>
          </div>
