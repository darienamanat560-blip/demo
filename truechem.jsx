          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 border-2 border-black p-10">
              <div className="flex items-start space-x-4">
                <div className="w-14 h-14 flex items-center justify-center flex-shrink-0"><VialIcon size={40} /></div>
                <div>
              ...
              <div className="space-y-6 max-w-2xl mx-auto">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="w-6 h-6 flex items-center justify-center"><VialIcon size={40} /></div>
